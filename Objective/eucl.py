...
def meshlab_ptoP_dist(Mesh1, Mesh2):
    #Check this filter in Meshlab.


# Transform distances to pandas frame, and calculate pearson. 
# Must they be normalized? Normalize them all against the B.B.D?